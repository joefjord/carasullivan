...
--
-- WHERE:  owner_id='carakxms' or owner_id REGEXP '@(carasullivan\.com)$'
...
-- Dump completed on 2014-09-16 21:56:13
-- MySQL dump 10.13  Distrib 5.5.32, for Linux (x86_64)
--
-- Host: localhost    Database: horde
-- ------------------------------------------------------
...
--
-- WHERE:  pref_uid='carakxms' or pref_uid REGEXP '@(carasullivan\.com)$'
...
--
-- WHERE:  share_owner='carakxms' or share_owner REGEXP '@(carasullivan\.com)$'
...
--
-- WHERE:  vfb_owner='carakxms' or vfb_owner REGEXP '@(carasullivan\.com)$'
...
--
-- WHERE:  memo_owner='carakxms' or memo_owner REGEXP '@(carasullivan\.com)$'
...
--
-- WHERE:  task_owner='carakxms' or task_owner REGEXP '@(carasullivan\.com)$'
